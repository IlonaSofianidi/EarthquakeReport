...
public final class QueryUtils {
     ...
     */
    public static ArrayList<EarthquakeEntity> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                EarthquakeEntity earthquakeEntity = new EarthquakeEntity(magnitude, location, date_earthquake);
    ...
    public static String extractEathquakeUrl(int position) {
        String url = null;

        try {
            JSONObject jsonObject = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray features = jsonObject.getJSONArray("features");
            JSONObject object_earthquake = features.getJSONObject(position);
            JSONObject properties = object_earthquake.getJSONObject("properties");
